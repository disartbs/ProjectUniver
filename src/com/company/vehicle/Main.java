...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GarageNetwork garageNetwork = new GarageNetwork("net");
//        GarageNetwork garageNetwork = new GarageNetwork("net", 2);
//        for(int i = 0; i<2;i++){
//            garageNetwork.addNewGarage();
//        }

        garageNetwork.addGarage(new Garage("London", vehiclesForGarageInLondon));
        garageNetwork.addGarage(new Garage("Tokyo", vehiclesForGarageInTokyo));
        garageNetwork.addGarage(new Garage("NY", vehiclesForGarageInNY));
        ...
        System.out.println(garageNetwork.findVehiclesGarage(number));
        Garage garage = garageNetwork.findVehiclesGarage(number);
        System.out.println(garage);
        Garage garage1 = garageNetwork.getGarage(0);
        if(garage1 != null)
